const benefits = [
  {
    title: "15–20 min",
    body: "Kort och konkret. Vi går rakt på sak.",
    icon: (
  ...
  {
    title: "Vi svarar på allt",
    body: "Pris, tidsplan, hosting, äganderätt — allt.",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    body: "Vardagar 09–18, även kvällar vid behov.",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section id="boka" className="py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16">
        <div>
          <span className="eyebrow">Boka en genomgång</span>
          <h2 className="mt-6 text-5xl sm:text-6xl font-bold tracking-tight leading-[1.05]">
            Vill ni ha en personlig genomgång?
          </h2>
          <p className="mt-8 text-lg text-foreground/70 leading-relaxed max-w-md">
            Mejla oss så bokar vi in ett kort samtal — vi går igenom hur det fungerar, svarar på frågor och visar exempel. Helt utan förpliktelser.
          </p>
        ...
        <div className="lg:mt-16">
          <div className="rounded-3xl bg-dark-bg text-white p-10 lg:p-12">
            ...
            <p className="mt-6 text-white/60 leading-relaxed">
              Skriv gärna när det passar er — så återkommer vi med tider.
            </p>
            <a
